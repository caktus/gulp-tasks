...
var argv;
exports.configure = function(defaults) {
...
export.tasks.modernizr = modernizrTask;
...
exports.tasks.default = function (cb) {
  configure();
  livereload.listen();
